...
public class PaintingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //para cambiar el color del texto de las pestañas al estar en reposo y al ser seleccionadas.
      ...
      //para agregar los títulos a las pestañas  y las vistas o fragments que se mostrarán dependiendo de la pestaña seleccionada
        ...
        viewPager = (ViewPager)view.findViewById(R.id.ViewPagerPainting);
    ...
    */
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter{
        ...
        String [] TabTittle = {"COLOR", "MÚSICA", "POESÍA"};
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new Tab_paintColor();
                case 1:
                    return new Tab_paintMusic();
                case 2:
                    return new Tab_paintPoesia();
            }
